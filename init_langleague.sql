-- =====================================================
-- LANGLEAGUE DATABASE INITIALIZATION SCRIPT
-- With sample data for Admin, Teacher, Student roles
-- =====================================================
...
-- =====================================================
-- Mark Liquibase as already run (to prevent re-running)
-- =====================================================
...
-- Admin: admin@langleague.com / admin
-- Teachers: teacher1@langleague.com, teacher2@langleague.com
-- Students: student1-5@langleague.com

SELECT 'Database initialized successfully!' AS Status;
SELECT 'Users created:' AS Info, COUNT(*) AS Count FROM jhi_user;
SELECT 'Books created:' AS Info, COUNT(*) AS Count FROM book;
SELECT 'Units created:' AS Info, COUNT(*) AS Count FROM unit;
SELECT 'Vocabularies created:' AS Info, COUNT(*) AS Count FROM vocabulary;
SELECT 'Grammars created:' AS Info, COUNT(*) AS Count FROM grammar;
SELECT 'Exercises created:' AS Info, COUNT(*) AS Count FROM exercise;
SELECT 'Enrollments created:' AS Info, COUNT(*) AS Count FROM enrollment;
