...
class BookResourceIT {
    ...
    public static Book createEntity(EntityManager em) {
        ...
        book.setTeacherProfile(userProfile);
        return book;
    }
    ...
    public static Book createUpdatedEntity(EntityManager em) {
        ...
        updatedBook.setTeacherProfile(userProfile);
        return updatedBook;
    }
    ...
    void partialUpdateBookWithPatch() throws Exception {
        ...
        partialUpdatedBook.title(UPDATED_TITLE).coverImageUrl(UPDATED_COVER_IMAGE_URL).createdAt(UPDATED_CREATED_AT);
