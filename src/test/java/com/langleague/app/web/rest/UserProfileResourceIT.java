...
import static com.langleague.app.domain.UserProfileAsserts.*;
...
class UserProfileResourceIT {
    ...
    private static final Integer DEFAULT_STREAK_COUNT = 1;
    private static final Integer UPDATED_STREAK_COUNT = 2;

    private static final Instant DEFAULT_LAST_LEARNING_DATE = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_LAST_LEARNING_DATE = Instant.now().truncatedTo(ChronoUnit.MILLIS);

    private static final String DEFAULT_BIO = "AAAAAAAAAA";
    private static final String UPDATED_BIO = "BBBBBBBBBB";

    private static final ThemeMode DEFAULT_THEME = ThemeMode.LIGHT;
    private static final ThemeMode UPDATED_THEME = ThemeMode.DARK;
    ...
    public static UserProfile createEntity(EntityManager em) {
        UserProfile userProfile = new UserProfile()
            .streakCount(DEFAULT_STREAK_COUNT)
            .lastLearningDate(DEFAULT_LAST_LEARNING_DATE)
            .bio(DEFAULT_BIO)
            .theme(DEFAULT_THEME);
        // Add required entity
    ...
    public static UserProfile createUpdatedEntity(EntityManager em) {
        UserProfile updatedUserProfile = new UserProfile()
            .streakCount(UPDATED_STREAK_COUNT)
            .lastLearningDate(UPDATED_LAST_LEARNING_DATE)
            .bio(UPDATED_BIO)
            .theme(UPDATED_THEME);
        // Add required entity
        User user = UserResourceIT.createEntity();
    ...
    void getAllUserProfiles() throws Exception {
        ...
        restUserProfileMockMvc
            ...
            .andExpect(jsonPath("$.[*].streakCount").value(hasItem(DEFAULT_STREAK_COUNT)))
            .andExpect(jsonPath("$.[*].lastLearningDate").value(hasItem(DEFAULT_LAST_LEARNING_DATE.toString())))
    ...
    void getUserProfile() throws Exception {
        ...
        restUserProfileMockMvc
            ...
            .andExpect(jsonPath("$.streakCount").value(DEFAULT_STREAK_COUNT))
            .andExpect(jsonPath("$.lastLearningDate").value(DEFAULT_LAST_LEARNING_DATE.toString()))
    ...
    void partialUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.streakCount(UPDATED_STREAK_COUNT).bio(UPDATED_BIO);
