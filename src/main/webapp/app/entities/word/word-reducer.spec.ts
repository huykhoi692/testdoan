...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './word.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WORD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WORD actions', async () => {
      const arg = { id: 9088 };
    ...
    it('dispatches UPDATE_WORD actions', async () => {
      const arg = { id: 9088 };
    ...
    it('dispatches PARTIAL_UPDATE_WORD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WORD actions', async () => {
      const arg = 42666;
