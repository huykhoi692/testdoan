...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_READINGOPTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_READINGOPTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_READINGOPTION actions', async () => {
      const arg = { id: 7713 };
    ...
    it('dispatches UPDATE_READINGOPTION actions', async () => {
      const arg = { id: 7713 };
    ...
    it('dispatches PARTIAL_UPDATE_READINGOPTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_READINGOPTION actions', async () => {
      const arg = 42666;
