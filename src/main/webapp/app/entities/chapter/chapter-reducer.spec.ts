...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './chapter.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHAPTER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHAPTER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHAPTER actions', async () => {
      const arg = { id: 28081 };
    ...
    it('dispatches UPDATE_CHAPTER actions', async () => {
      const arg = { id: 28081 };
    ...
    it('dispatches PARTIAL_UPDATE_CHAPTER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHAPTER actions', async () => {
      const arg = 42666;
