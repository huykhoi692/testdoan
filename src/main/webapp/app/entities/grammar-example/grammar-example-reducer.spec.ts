...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GRAMMAREXAMPLE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GRAMMAREXAMPLE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GRAMMAREXAMPLE actions', async () => {
      const arg = { id: 27684 };
    ...
    it('dispatches UPDATE_GRAMMAREXAMPLE actions', async () => {
      const arg = { id: 27684 };
    ...
    it('dispatches PARTIAL_UPDATE_GRAMMAREXAMPLE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GRAMMAREXAMPLE actions', async () => {
      const arg = 42666;
