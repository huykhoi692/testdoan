...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOOKREVIEW_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOOKREVIEW actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOOKREVIEW actions', async () => {
      const arg = { id: 16899 };
    ...
    it('dispatches UPDATE_BOOKREVIEW actions', async () => {
      const arg = { id: 16899 };
    ...
    it('dispatches PARTIAL_UPDATE_BOOKREVIEW actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BOOKREVIEW actions', async () => {
      const arg = 42666;
