...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VOCABULARY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VOCABULARY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VOCABULARY actions', async () => {
      const arg = { id: 25394 };
    ...
    it('dispatches UPDATE_VOCABULARY actions', async () => {
      const arg = { id: 25394 };
    ...
    it('dispatches PARTIAL_UPDATE_VOCABULARY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VOCABULARY actions', async () => {
      const arg = 42666;
