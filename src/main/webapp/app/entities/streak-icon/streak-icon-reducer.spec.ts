...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STREAKICON_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STREAKICON actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STREAKICON actions', async () => {
      const arg = { id: 22880 };
    ...
    it('dispatches UPDATE_STREAKICON actions', async () => {
      const arg = { id: 22880 };
    ...
    it('dispatches PARTIAL_UPDATE_STREAKICON actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STREAKICON actions', async () => {
      const arg = 42666;
