...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOOKPROGRESS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOOKPROGRESS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOOKPROGRESS actions', async () => {
      const arg = { id: 15610 };
    ...
    it('dispatches UPDATE_BOOKPROGRESS actions', async () => {
      const arg = { id: 15610 };
    ...
    it('dispatches PARTIAL_UPDATE_BOOKPROGRESS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BOOKPROGRESS actions', async () => {
      const arg = 42666;
