      ...
      <h2 id="book-heading" data-cy="BookHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="langleagueApp.book.home.refreshListLabel">Refresh List</Translate>
          </Button>
        ...
        {bookList && bookList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="langleagueApp.book.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th>
                  <Translate contentKey="langleagueApp.book.teacherProfile">Teacher Profile</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {bookList.map((book, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{book.createdAt ? <TextFormat type="date" value={book.createdAt} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{book.teacherProfile ? <Link to={`/user-profile/${book.teacherProfile.id}`}>{book.teacherProfile.id}</Link> : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="langleagueApp.book.home.notFound">No Books found</Translate>
            </div>
          )
        )}
      </div>
