...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXERCISERESULT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EXERCISERESULT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EXERCISERESULT actions', async () => {
      const arg = { id: 6074 };
    ...
    it('dispatches UPDATE_EXERCISERESULT actions', async () => {
      const arg = { id: 6074 };
    ...
    it('dispatches PARTIAL_UPDATE_EXERCISERESULT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EXERCISERESULT actions', async () => {
      const arg = 42666;
