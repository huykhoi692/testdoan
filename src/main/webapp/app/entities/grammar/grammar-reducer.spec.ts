...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './grammar.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GRAMMAR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GRAMMAR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GRAMMAR actions', async () => {
      const arg = { id: 13647 };
    ...
    it('dispatches UPDATE_GRAMMAR actions', async () => {
      const arg = { id: 13647 };
    ...
    it('dispatches PARTIAL_UPDATE_GRAMMAR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GRAMMAR actions', async () => {
      const arg = 42666;
