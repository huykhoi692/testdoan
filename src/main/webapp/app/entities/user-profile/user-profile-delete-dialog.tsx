...
export const UserProfileDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="langleagueApp.userProfile.delete.question">
        <Translate contentKey="langleagueApp.userProfile.delete.question" interpolate={{ id: userProfileEntity.id }}>
