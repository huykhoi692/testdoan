 ...
 * This should be used by normal users to fetch their own profile
 */
export const getCurrentUserProfile = createAsyncThunk(
  'userProfile/fetch_current_user_profile',
  async () => {
...
/**
 * @deprecated For normal users, use getCurrentUserProfile() instead
 * This endpoint fetches ALL user profiles and should only be used by admins
 */
...
export const UserProfileSlice = createEntitySlice({
  ...
  extraReducers(builder) {
    builder
      ...
      .addMatcher(isPending(getEntities, getEntity, getCurrentUserProfile), state => {
