    ...
    <Row>
      <Col md="8">
        <h2 data-cy="commentDetailsHeading">
          <Translate contentKey="langleagueApp.comment.detail.title">Comment</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="langleagueApp.comment.appUser">App User</Translate>
          </dt>
          <dd>{commentEntity.appUser ? commentEntity.appUser.id : ''}</dd>
        </dl>
