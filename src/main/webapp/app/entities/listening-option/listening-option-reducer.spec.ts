...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LISTENINGOPTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LISTENINGOPTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LISTENINGOPTION actions', async () => {
      const arg = { id: 23202 };
    ...
    it('dispatches UPDATE_LISTENINGOPTION actions', async () => {
      const arg = { id: 23202 };
    ...
    it('dispatches PARTIAL_UPDATE_LISTENINGOPTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LISTENINGOPTION actions', async () => {
      const arg = 42666;
