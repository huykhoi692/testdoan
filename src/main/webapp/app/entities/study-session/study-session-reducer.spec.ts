...
import { IStudySession, defaultValue } from '../../shared/model/study-session.model';
import reducer, {
  createEntity,
  deleteEntity,
  getEntities,
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STUDYSESSION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STUDYSESSION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STUDYSESSION actions', async () => {
      const arg = { id: 6091 };
    ...
    it('dispatches UPDATE_STUDYSESSION actions', async () => {
      const arg = { id: 6091 };
    ...
    it('dispatches PARTIAL_UPDATE_STUDYSESSION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STUDYSESSION actions', async () => {
      const arg = 42666;
