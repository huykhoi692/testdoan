...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHAPTERPROGRESS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHAPTERPROGRESS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHAPTERPROGRESS actions', async () => {
      const arg = { id: 8160 };
    ...
    it('dispatches UPDATE_CHAPTERPROGRESS actions', async () => {
      const arg = { id: 8160 };
    ...
    it('dispatches PARTIAL_UPDATE_CHAPTERPROGRESS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHAPTERPROGRESS actions', async () => {
      const arg = 42666;
