...
export const AchievementDeleteDialog = () => {
  ...
  const handleClose = useCallback(() => {
    navigate(`/achievement${pageLocation.search}`);
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="langleagueApp.achievement.delete.question">
        <Translate contentKey="langleagueApp.achievement.delete.question" interpolate={{ id: achievementEntity.id }}>
