...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERGRAMMAR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERGRAMMAR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERGRAMMAR actions', async () => {
      const arg = { id: 5758 };
    ...
    it('dispatches UPDATE_USERGRAMMAR actions', async () => {
      const arg = { id: 5758 };
    ...
    it('dispatches PARTIAL_UPDATE_USERGRAMMAR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERGRAMMAR actions', async () => {
      const arg = 42666;
