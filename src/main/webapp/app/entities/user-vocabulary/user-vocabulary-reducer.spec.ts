...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERVOCABULARY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERVOCABULARY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERVOCABULARY actions', async () => {
      const arg = { id: 5408 };
    ...
    it('dispatches UPDATE_USERVOCABULARY actions', async () => {
      const arg = { id: 5408 };
    ...
    it('dispatches PARTIAL_UPDATE_USERVOCABULARY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERVOCABULARY actions', async () => {
      const arg = 42666;
