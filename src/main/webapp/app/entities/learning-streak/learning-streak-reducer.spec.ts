...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEARNINGSTREAK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LEARNINGSTREAK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LEARNINGSTREAK actions', async () => {
      const arg = { id: 4185 };
    ...
    it('dispatches UPDATE_LEARNINGSTREAK actions', async () => {
      const arg = { id: 4185 };
    ...
    it('dispatches PARTIAL_UPDATE_LEARNINGSTREAK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LEARNINGSTREAK actions', async () => {
      const arg = 42666;
