...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_READINGEXERCISE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_READINGEXERCISE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_READINGEXERCISE actions', async () => {
      const arg = { id: 25886 };
    ...
    it('dispatches UPDATE_READINGEXERCISE actions', async () => {
      const arg = { id: 25886 };
    ...
    it('dispatches PARTIAL_UPDATE_READINGEXERCISE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_READINGEXERCISE actions', async () => {
      const arg = 42666;
