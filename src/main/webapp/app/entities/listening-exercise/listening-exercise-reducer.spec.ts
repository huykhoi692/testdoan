...
import { IListeningExercise, defaultValue } from 'app/shared/model/listening-exercise.model';
import reducer, {
  createEntity,
  deleteEntity,
  getEntities,
  ...
  reset,
  updateEntity,
} from './listening-exercise.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LISTENINGEXERCISE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LISTENINGEXERCISE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LISTENINGEXERCISE actions', async () => {
      const arg = { id: 19875 };
    ...
    it('dispatches UPDATE_LISTENINGEXERCISE actions', async () => {
      const arg = { id: 19875 };
    ...
    it('dispatches PARTIAL_UPDATE_LISTENINGEXERCISE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LISTENINGEXERCISE actions', async () => {
      const arg = 42666;
