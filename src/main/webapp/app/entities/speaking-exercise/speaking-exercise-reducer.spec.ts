...
import reducer, {
  ...
  reset,
  updateEntity,
} from './speaking-exercise.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPEAKINGEXERCISE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SPEAKINGEXERCISE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SPEAKINGEXERCISE actions', async () => {
      const arg = { id: 30074 };
    ...
    it('dispatches UPDATE_SPEAKINGEXERCISE actions', async () => {
      const arg = { id: 30074 };
    ...
    it('dispatches PARTIAL_UPDATE_SPEAKINGEXERCISE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SPEAKINGEXERCISE actions', async () => {
      const arg = 42666;
