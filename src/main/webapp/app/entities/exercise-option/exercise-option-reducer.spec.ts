...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXERCISEOPTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EXERCISEOPTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EXERCISEOPTION actions', async () => {
      const arg = { id: 23369 };
    ...
    it('dispatches UPDATE_EXERCISEOPTION actions', async () => {
      const arg = { id: 23369 };
    ...
    it('dispatches PARTIAL_UPDATE_EXERCISEOPTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EXERCISEOPTION actions', async () => {
      const arg = 42666;
