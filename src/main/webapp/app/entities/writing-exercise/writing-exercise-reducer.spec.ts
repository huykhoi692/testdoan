...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WRITINGEXERCISE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WRITINGEXERCISE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WRITINGEXERCISE actions', async () => {
      const arg = { id: 17648 };
    ...
    it('dispatches UPDATE_WRITINGEXERCISE actions', async () => {
      const arg = { id: 17648 };
    ...
    it('dispatches PARTIAL_UPDATE_WRITINGEXERCISE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WRITINGEXERCISE actions', async () => {
      const arg = 42666;
