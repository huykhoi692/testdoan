...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORDEXAMPLE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WORDEXAMPLE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WORDEXAMPLE actions', async () => {
      const arg = { id: 24505 };
    ...
    it('dispatches UPDATE_WORDEXAMPLE actions', async () => {
      const arg = { id: 24505 };
    ...
    it('dispatches PARTIAL_UPDATE_WORDEXAMPLE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WORDEXAMPLE actions', async () => {
      const arg = 42666;
