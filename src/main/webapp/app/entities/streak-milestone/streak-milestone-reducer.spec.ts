...
import { IStreakMilestone, defaultValue } from '../../shared/model/streak-milestone.model';
import reducer, {
  createEntity,
  deleteEntity,
  getEntities,
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STREAKMILESTONE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STREAKMILESTONE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STREAKMILESTONE actions', async () => {
      const arg = { id: 3862 };
    ...
    it('dispatches UPDATE_STREAKMILESTONE actions', async () => {
      const arg = { id: 3862 };
    ...
    it('dispatches PARTIAL_UPDATE_STREAKMILESTONE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STREAKMILESTONE actions', async () => {
      const arg = 42666;
