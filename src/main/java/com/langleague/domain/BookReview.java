...
public class BookReview implements Serializable {
    ...
    public BookReview createdAt(Instant createdAt) {
    ...
    public BookReview updatedAt(Instant updatedAt) {
    ...
    public BookReview appUser(AppUser appUser) {
    ...
    public BookReview book(Book book) {
        this.setBook(book);
        return this;
    }
