...
import com.langleague.app.service.MailService;
import com.langleague.app.service.UserService;
import com.langleague.app.service.dto.AdminUserDTO;
import com.langleague.app.web.rest.errors.BadRequestAlertException;
import com.langleague.app.web.rest.errors.EmailAlreadyUsedException;
import com.langleague.app.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link com.langleague.app.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
...
public class UserResource {
    ...
    public ResponseEntity<List<AdminUserDTO>> getAllUsers(
        ...
        if ("active".equalsIgnoreCase(status)) {
            activated = true;
        } else if ("suspended".equalsIgnoreCase(status) || "inactive".equalsIgnoreCase(status)) {
            activated = false;
        }
        ...
        final Page<AdminUserDTO> page = userService.getAllManagedUsers(login, role, activated, pageable);
